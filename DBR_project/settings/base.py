"""
Django settings for DBR_project project.
...
ALLOWED_HOSTS =127.0.0.1, .localhost, https://ribsontcc2021.herokuapp.com/
...
WSGI_APPLICATION = 'DBR_project.wsgi.application'
